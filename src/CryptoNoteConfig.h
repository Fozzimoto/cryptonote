...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xd575c;
...
const uint64_t DIFFICULTY_TARGET                             = 244; // seconds
...
const char     CRYPTONOTE_NAME[]                             = "dust";
...
const int      P2P_DEFAULT_PORT                              = 8188;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 8189;
